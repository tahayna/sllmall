...
<head>
    ...
    <title>Become A Seller - {{ config('app.name', 'Sllmall') }}</title>
...
<body>
                            ...
                            <div class="information">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-4">
                                     ...
                                     <div class="col-md-12 mt-4">
                                            <x-file name="shop_registration_certificate"
                                                label="Shop Registration Certificate"
                                                required="true"
                                                accept=".pdf,.jpg,.jpeg,.png"
                                            />
                                            <p class="text text-danger m-0" id="shop_registration_certificate_error"></p>
                                        </div>
                                </div>
                            </div>
                            <div class="col-md-12 mt-4">
    ...
    <script>
    $(function () {
        const $cb = $('#accept_terms');
        const $btn = $('#submitBtn');

        function syncSubmit() {
            const ok = $cb.is(':checked');
