...
@section('content')
    ...
    <div class="col-md-4 mt-3">
        <div>
            ...
            <input type="text" name="opening_time" id="timepicker"
                   class="form-control"
                   value="{{ old('opening_time', $shop->opening_time ? substr($shop->opening_time,0,5) : '') }}"
                   required>
        </div>
        ...
        <div class="mt-3">
            ...
            <input type="text" name="closing_time" id="timepicker2"
                   class="form-control"
                   value="{{ old('closing_time', $shop->closing_time ? substr($shop->closing_time,0,5) : '') }}"
                   required>
        </div>
    </div>
